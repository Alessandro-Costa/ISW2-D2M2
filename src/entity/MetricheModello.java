package entity;
	...
	public class MetricheModello {
		...
		public MetricheModello(String dataset, String[] classBalaFeatu, int trainingReleaseNumber, double[] trainPercDefTrainDefTest, int[] tpTnFpFn, double[] precRecRocKap) {
